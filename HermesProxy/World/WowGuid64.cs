...
public class WowGuid64 : WowGuid
{
	...
	public HighGuidTypeLegacy GetHighGuidTypeLegacy()
	{
		...
		return (HighGuidTypeLegacy)((Low >> 48) & 0xFFFF);
	}
	...
	public override string ToString()
	{
		...
		if (HasEntry())
		{
			return "Full: 0x" + Low.ToString("X8") + " Type: " + GetHighType() + " Entry: " + GetEntry() + " Low: " + GetCounter();
		}
		return "Full: 0x" + Low.ToString("X8") + " Type: " + GetHighType() + " Low: " + GetCounter();
	}
