...
using ActivePlayerField = HermesProxy.World.Enums.V2_5_2_39570.ActivePlayerField;
using ContainerField = HermesProxy.World.Enums.V2_5_2_39570.ContainerField;
using CorpseField = HermesProxy.World.Enums.V2_5_2_39570.CorpseField;
using DynamicObjectField = HermesProxy.World.Enums.V2_5_2_39570.DynamicObjectField;
using GameObjectField = HermesProxy.World.Enums.V2_5_2_39570.GameObjectField;
using ItemField = HermesProxy.World.Enums.V2_5_2_39570.ItemField;
using ObjectField = HermesProxy.World.Enums.V2_5_2_39570.ObjectField;
using PlayerField = HermesProxy.World.Enums.V2_5_2_39570.PlayerField;
using UnitDynamicField = HermesProxy.World.Enums.V2_5_2_39570.UnitDynamicField;
using UnitField = HermesProxy.World.Enums.V2_5_2_39570.UnitField;
...
public class ObjectUpdateBuilder
{
	...
	public void WriteValuesToArray()
	{
		...
		if (playerData != null)
		{
			...
			for (var num16 = 0; num16 < 36; num16++)
			{
				var startIndex22 = 687;
				var sizePerEntry6 = 2;
		...
		if (activeData != null && m_objectType == ObjectTypeBCC.ActivePlayer)
		{
			...
			if (activeData.TodayHonorableKills.HasValue && activeData.YesterdayHonorableKills.HasValue)
			{
				...
				m_fields.SetUpdateField(ActivePlayerField.ACTIVE_PLAYER_FIELD_BYTES_2, activeData.YesterdayHonorableKills.Value, 1);
			}
			if (activeData.LastWeekHonorableKills.HasValue && activeData.ThisWeekHonorableKills.HasValue)
			{
				m_fields.SetUpdateField(ActivePlayerField.ACTIVE_PLAYER_FIELD_BYTES_3, activeData.LastWeekHonorableKills.Value);
				m_fields.SetUpdateField(ActivePlayerField.ACTIVE_PLAYER_FIELD_BYTES_3, activeData.ThisWeekHonorableKills.Value, 1);
			}
			...
			if (activeData.LocalRegenFlags.HasValue || activeData.AuraVision.HasValue || activeData.NumBackpackSlots.HasValue)
			{
				...
				{
					m_fields.SetUpdateField(ActivePlayerField.ACTIVE_PLAYER_FIELD_BYTES_4, activeData.LocalRegenFlags.Value);
				}
				if (activeData.AuraVision.HasValue)
				{
					m_fields.SetUpdateField(ActivePlayerField.ACTIVE_PLAYER_FIELD_BYTES_4, activeData.AuraVision.Value, 1);
				}
				if (activeData.NumBackpackSlots.HasValue)
				{
					m_fields.SetUpdateField(ActivePlayerField.ACTIVE_PLAYER_FIELD_BYTES_4, activeData.NumBackpackSlots.Value, 2);
				}
			}
			...
			if (activeData.InsertItemsLeftToRight.HasValue || activeData.PvPRankProgress.HasValue)
			{
				...
				{
					m_fields.SetUpdateField(ActivePlayerField.ACTIVE_PLAYER_FIELD_BYTES_5, activeData.PvPRankProgress.Value, 1);
				}
			}
		...
		if (corpseData != null)
		{
			...
			for (var num47 = 0; num47 < 36; num47++)
			{
				var startIndex58 = 43;
