...
using ActivePlayerField = HermesProxy.World.Enums.V2_5_3_41750.ActivePlayerField;
using ContainerField = HermesProxy.World.Enums.V2_5_3_41750.ContainerField;
using CorpseField = HermesProxy.World.Enums.V2_5_3_41750.CorpseField;
using DynamicObjectField = HermesProxy.World.Enums.V2_5_3_41750.DynamicObjectField;
using GameObjectField = HermesProxy.World.Enums.V2_5_3_41750.GameObjectField;
using ItemField = HermesProxy.World.Enums.V2_5_3_41750.ItemField;
using ObjectField = HermesProxy.World.Enums.V2_5_3_41750.ObjectField;
using PlayerField = HermesProxy.World.Enums.V2_5_3_41750.PlayerField;
using UnitDynamicField = HermesProxy.World.Enums.V2_5_3_41750.UnitDynamicField;
using UnitField = HermesProxy.World.Enums.V2_5_3_41750.UnitField;
	...
	public void WriteValuesToArray()
	{
		...
		if (activeData != null && m_objectType == ObjectTypeBCC.ActivePlayer)
		{
			...
			if (activeData.HasDailyQuestsUpdate)
			{
				...
				m_dynamicFields.SetUpdateField(6, fields3, DynamicFieldChangeType.ValueAndSizeChanged);
			}
		}
