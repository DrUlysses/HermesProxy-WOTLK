...
using ActivePlayerField = HermesProxy.World.Enums.V1_14_0_40237.ActivePlayerField;
using ContainerField = HermesProxy.World.Enums.V1_14_0_40237.ContainerField;
using CorpseField = HermesProxy.World.Enums.V1_14_0_40237.CorpseField;
using DynamicObjectField = HermesProxy.World.Enums.V1_14_0_40237.DynamicObjectField;
using GameObjectField = HermesProxy.World.Enums.V1_14_0_40237.GameObjectField;
using ItemField = HermesProxy.World.Enums.V1_14_0_40237.ItemField;
using ObjectField = HermesProxy.World.Enums.V1_14_0_40237.ObjectField;
using PlayerField = HermesProxy.World.Enums.V1_14_0_40237.PlayerField;
using UnitDynamicField = HermesProxy.World.Enums.V1_14_0_40237.UnitDynamicField;
using UnitField = HermesProxy.World.Enums.V1_14_0_40237.UnitField;
...
public class ObjectUpdateBuilder
{
	...
	public void WriteValuesToArray()
	{
		...
		if (activeData != null && m_objectType == ObjectTypeBCC.ActivePlayer)
		{
			...
			for (var num42 = 0; num42 < activeData.QuestCompleted.Length; num42++)
			{
				var startIndex54 = 2926;
